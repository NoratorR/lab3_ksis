    ...
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try {
                ...
                departList =  connect.StartConnection();
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            if (curType == typeof(Jober))
            {
                ...
                connect.DeleteWorker(jbr.JoberID,curDep.DepartmentID);
                UppdateWorker();
                UppdateComputer();
            }
            if (curType == typeof(Computer))
            {
                ...
                connect.DeleteComputer(cmp.computerID,curDep.DepartmentID);
                UppdateWorker();
                UppdateComputer();
            }
            if (curType == typeof(Department))
            {
                connect.DeleteDepartment(curDep);
                UppdateDepartment();
                if (comboBox1.Text == "")
                {
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if (curType == typeof(Jober))
                {
                    ...
                    connect.CreateWorker(jbr,curDep.DepartmentID);
                    WorkID++;
                    UppdateWorker();
                }
                if (curType == typeof(Computer))
                {
                    ...
                    connect.CreateComputer(cmp, curDep.DepartmentID);
                    UppdateComputer();
                }
            }
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            { 
                ...
                Jober jbr = departList[index].workerList.Find(p => p.workerName == curWorkerStr);
                Computer cmp = departList[index].computerList.Find(p => p.computerName == curComputerStr);
                connect.AddComputer(cmp.computerID, jbr, curDep.DepartmentID);
                UppdateWorker();
                UppdateComputer();
            }
            if (curType == typeof(Computer))
            {
                ...
                Jober jbr = departList[index].workerList.Find(p => p.workerName == curWorkerStr);
                Computer cmp = departList[index].computerList.Find(p => p.computerName == curComputerStr);
                connect.AddWorker(jbr.JoberID,cmp,curDep.DepartmentID);
                UppdateWorker();
                UppdateComputer();
            }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (curType == typeof(Jober))
            {
                var index = departList.FindIndex(p => p.DepartmentID == curDep.DepartmentID);
                Jober jbr = departList[index].workerList.Find(p => p.workerName == curWorkerStr);
                connect.ChangeWorker(jbr.JoberID,curDep.DepartmentID,textBox2.Text);
                UppdateWorker();
                UppdateComputer();
            }
            if (curType == typeof(Computer))
            {
                var index = departList.FindIndex(p => p.DepartmentID == curDep.DepartmentID);
                Computer cmp = departList[index].computerList.Find(p => p.computerName == curComputerStr);
                connect.ChangeComputer(cmp.computerID,curDep.DepartmentID, textBox2.Text);
                UppdateWorker();
                UppdateComputer();
            }
            if (curType == typeof(Department))
            {
                ...
                connect.ChangeDepartment(curDep,textBox2.Text);
                UppdateDepartment();
                comboBox1.Text = curDep.departName;
            }
        }
